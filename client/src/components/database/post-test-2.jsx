...
import QuestionTable from "../../assets/question2-table";
import {
  TextField,
  Button,
  Container,
...
class Page10Question extends React.Component {
  ...
  componentDidMount = async () => {
    const doc = await axios.get("/api/post-test-2/questions");
  ...
  handleAdd = async () => {
    await axios.post("/api/post-test-2/questions", {
  ...
  handleDelete = async (id) => {
    await axios.delete("/api/post-test-2/questions/" + id);
