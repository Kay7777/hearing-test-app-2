...
class PostTestQuestions extends React.Component {
  ...
  componentDidMount = async () => {
    const doc1 = await axios.get("/api/post-test-1/questions");
    const doc2 = await axios.get("/api/post-test-2/questions");
    const doc3 = await axios.get("/api/post-test-3/questions");
